...
themeManager = {
    'install': function (file_name) {
        $.post(U('admin/Theme/install'),{name:file_name},function(msg){
            handleAjax(msg);
        })
    },
    'uninstall': function (file_name) {
        $.post(U('admin/Theme/uninstall'),{name:file_name},function(msg){
            handleAjax(msg);
        })
