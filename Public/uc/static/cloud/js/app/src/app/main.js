define("app/src/app/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./page"],
    function(e) {
        e("lib/jquery-lib"),
            e("lib/util"),
        ...
        function(require, exports) {
            return {
                ...
                path2url: function(e) {
                    ...
                    var a = G.app_host + "./index.php?s=/admin/explorer/fileProxy&path=" + urlEncode(e);
                ...
                explorer: function(e, a) {
                    ...
                    var t = "./index.php?s=/admin/explorer&type=iframe&path=" + e;
            ...
            var e, a = function() {
                    ...
                    e || (e = "all"),
                        ...
                        $(".box .list").live("hover",
                            ...
                            function() {
                                var e = "./index.php?s=/admin/setting/set&k=" + type + "&v=" + value;
                                $.ajax({
                                    url: e,
                                    type: "json",
                                    success: function(e) {
                                ...
                                if ($(e.target).attr("action")) {
                                    ...
                                    switch (t) {
                                        ...
                                        case "del":
                                            $.ajax({
                                                url:
                                                "./index.php?s=/admin/app/del&name=" + urlEncode(a.name),
                                                dataType: "json",
                                                error: core.ajaxError,
                                                success: function(e) {
                                                    tips(e.data, e.code),
                ...
                t = function(e) {
                    ...
                    G.is_root || (t = "");
                    for (var i in e) {
                        var n = e[i].icon; - 1 == n.search(G.static_path) && "http" != n.substring(0, 4) && (n = G.static_path + "images/app/" + n),
                            a += "<li class='app_li' data=" + urlEncode(json_encode(e[i])) + ">				<a action='preview' href='javascript:;' class='icon'><img action='preview' src='" + n + "'></a>				<p><span class='title'>" + e[i].name + "</span>				<span class='info'>" + e[i].desc + "</span></p>" + "<div class='btn-group'>				<button type='button' class='btn btn-sm btn-default' action='add'>添加</button>" + t + "</div><div style='clear:both;'></div></li>"
                    }
                    return a += "<div style='clear:both;'></div>"
                },
                i = function(a) { (void 0 == a || "" == a) && (a = e),
                    window.location.href = "#" + a,
                    $(".selected").removeClass("selected"),
                    $("ul.setting li#" + a).addClass("selected"),
                    $(".main").find(".h1").html($(".selected").html());
                    var i = $(".main .app-list");
                    $.ajax({
                        url: "./index.php?s=/admin/app/get&group=" + a,
                        dataType: "json",
                        beforeSend: function() {},
                        success: function(e) {
                            i.html(t(e.data)),
