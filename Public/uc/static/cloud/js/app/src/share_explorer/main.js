define("app/src/share_explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../share_common/rightMenu", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path", "../../share_common/topbar"],
    function(e) {
        Config = {
            ...
            e("lib/picasa/picasa"),
            ui = e("./ui"),
            rightMenu = e("../../share_common/rightMenu"),
    ...
    define("app/src/share_explorer/ui", ["./fileSelect"],
        function(require, exports) {
            ...
            var _ajaxLive = function() {
                ...
                _setListType = function(e, t) {
                    G.list_type = e,
                        _initListType(e),
                        Cookie.set("list_type", e),
                        void 0 == t ? _f5(!1, !1) : _f5(!1, !0)
                },
                ...
                _setListSort = function(e, t) {
                    ...
                    0 != t && (G.sort_order = t, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + t).addClass("selected")),
                        _f5(!1, !0),
                        Cookie.set("sort_field", G.sort_field),
                        Cookie.set("sort_order", G.sort_order)
                },
                ...
                _bindEventTools = function() {
                    $(".tools a,.tools button,.tools_list button").bind("click",
                        function() {
                            var e = $(this).attr("id");
                            _toolsAction(e)
                        })
            ...
            this._hover_title = function(e) {
                ...
                this._getFolderBox = function(e) {
                    var t = "";
                    return t += "<div class='file folderBox menufolder' data-name='" + e.name + "'" + _hover_title(e) + ">",
                        t += "<div class='folder ico' filetype='folder'></div>",
                        t += "<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + e.name + "</span></div></div>"
                },
                this._getFileBox = function(e) {
                    ...
                    if ("oexe" == e.ext && void 0 != e.icon) {
                        ...
                        t = "<div class='file fileBox menufile' data-app=" + i + " data-name='" + e.name + "'" + _hover_title(e) + ">",
                            "app_link" == e.type ? (t += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(n) + " ico'": "<div class='folder ico'", t += ' filetype="oexe"></div><div class="app_link"></div>') : t += "<div class='ico' filetype='oexe' style='background-image:url(" + a + ")'></div>",
                            t += "<div id='' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + n + "</span></div></div>"
                ...
                this._getFolderBoxList = function(e) {
                    ...
                    return t += "	<div class='folder ico' filetype='folder'></div>",
                        t += "	<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + e.name + "</span></div>",
                        t += "	<div class='filetype'>" + LNG.folder + "</div>",
                        t += "	<div class='filesize'></div>",
                ...
                this._getFileBoxList = function(e) {
                    ...
                    if ("oexe" == e.ext) {
                        var i = urlEncode(json_encode(e));
                        a = e.name.replace(".oexe", ""),
                            t = "<div class='file fileBox menufile' data-app=" + i + _hover_title(e) + ">",
                            "app_link" == e.type ? (t += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(a) + " ico'": "<div class='folder ico'", t += ' filetype="oexe"></div><div class="app_link"></div>') : t += "<div class='oexe ico' filetype='oexe'></div>"
                    } else if (inArray(core.filetype.image, e.ext)) {
            ...
            var pathTypeChange = function() {
                    ...
                    e.removeClass("menuBodyMain").addClass("menuBodyMain"),
                        $(".tools-left>.btn-group").addClass("hidden").parent().find(".kod_path_tool").removeClass("hidden")
                },
                    ...
                    if (void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e) $.ajax({
                        ...
                        success: function(e) {
                            return $(".tools-left .msg").fadeOut(100),
                                e.code ? (G.json_data = e.data, _f5_time_user(), Global.historyStatus = G.json_data.history_status, _mainSetData(t), pathTypeChange(), ui.header.addressSet(), "function" == typeof a && a(e), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
                        },
            ...
            return {
                ...
                init: function() {
                    Cookie.get("theme") && (G.theme = Cookie.get("theme")),
                    Cookie.get("list_type") && (G.list_type = Cookie.get("list_type")),
                    Cookie.get("sort_field") && (G.sort_field = Cookie.get("sort_field")),
                    Cookie.get("sort_order") && (G.sort_order = Cookie.get("sort_order")),
    ...
    define("app/src/share_explorer/fileSelect", [],
        function() {
            var e = !1,
                t = !1,
                a = !1,
                ...
                n = function() {
                    $(Config.FileBoxClass).die("touchstart").live("touchstart",
                        ...
                        $(".fileContiner .download .btn").die("click").live("click",
                            function(e) {
                                return ui.path.download(),
                                    stopPP(e),
                                    !1
                            }),
                ...
                s = function() {
                    ...
                    var u = function(e) {
                        ...
                        f = function() {
                            return t ? (t = !1, c = !1, $("body").css("cursor", "auto"), $(".draggable-dragging").fadeOut(200,
                                function() {
                                    $(this).remove()
                                }), void 0) : !1
                        },
    ...
    define("app/share_common/rightMenu", [],
        function() {
            var e = ".menufile",
                t = ".menufolder",
                a = ".menuMore",
                ...
                d = function() {
                    $('<i class="' + t.substr(1) + '"></i>').appendTo("#rightMenu"),
                        $.contextMenu({
                            zIndex: 9999,
                            selector: t,
                ...
                u = function() {
                    $('<i class="' + a.substr(1) + '"></i>').appendTo("#rightMenu"),
                        $.contextMenu({
                            zIndex: 9999,
                            selector: a,
                ...
                v = function() {
                    $('<i class="' + n.substr(1) + '"></i>').appendTo("#rightMenu"),
                        $.contextMenu({
                            zIndex: 9999,
                            selector: n,
                            callback: function(e) {
                ...
                menuShow: function() {
                    ...
                    if (0 != e.length && 0 != t.length) {
                        ...
                        if (t.hasClass("menufile")) {
                            ...
                            "zip" == n ? e.find(".unzip").show() : e.find(".unzip").hide(),
                                "html" == n || "htm" == n || "oexe" == n ? e.find(".open_text").show() : e.find(".open_text").hide()
                        }
            ...
            var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"],
                ...
                l = function(e, t) {
                    if (! (1 > e.length)) {
                        ...
                        "*recycle*/" == G.this_path && (s = LNG.recycle_remove + "?", o = "index.php?explorer/pathDeleteRecycle", i = LNG.recycle_remove),
                        "share" == e[0].type && (s = LNG.share_remove_tips, o = "index.php?userShare/del", i = LNG.share_remove),
        ...
        function(e) {
            var t = function(e, t) {
                ...
                r = function(e) {
                    ...
                    } else $.get("./index.php?explorer/makeFileProxy&path=" + urlEncode(e),
                        function(t) {
...
define("app/src/share_explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"],
    function(e) {
        ...
        var n = function(e, t, a) {
            ...
            s = function() {
                var e = ["/"],
                    ...
                    s = function() {
                        t == e.length - 1 ? $("#history_next").addClass("active") : $("#history_next").removeClass("active"),
                            0 == t ? $("#history_back").addClass("active") : $("#history_back").removeClass("active")
                    };
                return {
                    add: a,
                    back: n,
        ...
        return {
            ...
            open: function(e) {
                if (0 != c().path.length) {
                    ...
                    if (inArray(core.filetype.image, t.type)) return "icon" == G.list_type || "desktop" == Config.pageApp ? ui.picasa.play($(i).find(".ico")) : ui.picasa.play($(i)),
                        void 0;
                    if ("oexe" == t.type) {
    ...
    define("app/share_common/topbar", [],
        function() {
            var e = "index.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid,
                t = "index.php?share/fileProxy&user=" + G.user + "&sid=" + G.sid,
                a = function() {
                    "file" != G.share_info.type && G.path !== void 0 ? (t += "&path=" + G.path, e += "&path=" + G.path, $(".btn.button_my_share").hide(), $(".share_info_user .btn-group").show()) : ($(".btn.button_my_share").show(), $(".share_info_user .btn-group").hide()),
                    "file" == G.share_info.type && ($(".btn.button_my_share").hide(), $(".share_info_user .btn-group").show()),
                    "1" == G.share_info.not_download && (e = "javascript:core.tips.tips('" + LNG.share_not_download_tips + "',false);"),
                        $(".share_info_user").removeClass("hidden"),
                        $(".btn_download").attr("href", e);
                    var a = date("Y/m/d h:i", G.share_info.mtime);
                    $(".topbar .time").html(a),
                    "file" == G.share_info.type && $(".topbar .size").html(G.share_info.size),
                        $(".topbar .info").html(LNG.share_view_num + G.share_info.num_view + "  " + LNG.share_download_num + G.share_info.num_download),
                        $("#button_share").die("click").live("click",
                            function() {
                                i()
                            })
                },
