define("app/src/share_index/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../share_common/topbar", "./fileShow", "../edit/mode"],
    function(e) {
        Global = {
            topbar_height: 40,
            frameLeftWidth: 200,
    ...
    define("app/src/share_index/fileShow", ["../edit/mode"],
        function(e) {
            var t = "index.php?share/fileDownload&user=" + G.user + "&sid=" + G.sid,
                ...
                i = function() {
                    if (G.share_info !== void 0) {
                        ...
                        "file" != G.share_info.type && (a += "&path=" + G.path, t += "&path=" + G.path),
                        "1" == G.share_info.not_download && (t = "javascript:core.tips.tips('" + LNG.share_not_download_tips + "',false);"),
                            topbar.init(),
                            r(e)
                ...
                n = function() {
                    ...
                    a.removeClass("hidden"),
                        a.find(".name").html(G.share_info.name),
                        a.find(".ico").addClass(e),
                        a.find(".btn_download").attr("href", t);
                    var i = date("Y/m/d h:i", G.share_info.mtime);
                    a.find(".share_time").html(i),
                        a.find(".size span").html(G.share_info.size)
                },
                s = function(e) {
                ...
                r = function(e) {
                    if (inArray(core.filetype.text, e) || inArray(core.filetype.code, e)) return o(),
                        void 0;
                    if ("swf" == e) {
                        var t = core.createFlash(a, "", "");
                        return $(".content_box").addClass("show_swf").append(t),
                            void 0
                    }
                    if ("pdf" == e) {
                        if (Global.isIE) return n(),
                            void 0;
                        ...
                        return $(".content_box").attr("id", "show_pdf").append(t),
                            new PDFObject({
                                url: a
                            }).embed("show_pdf"),
                            void 0
                    ...
                    if (inArray(core.filetype.image, e)) {
                        var t = '<img src="' + a + '"/>';
                        return $(".content_box").addClass("show_image").append(t),
                            void 0
                    }
                    if (inArray(core.filetype.music, e) || inArray(core.filetype.movie, e)) {
                        ...
                        return $(".content_box").addClass(s).append(t),
                            void 0
                    }
                    if (inArray(core.filetype.doc, e)) {
                        var d = document.domain;
                        if ("" == G.office_server) {
                            if (0 == d.search("localhost") || 0 == d.search("192.168.") || 0 == d.search("127.0.0")) return n(),
                                void 0;
                        ...
                        return $(".frame-main").addClass("office_page").append(t),
