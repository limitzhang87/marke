...
var nativeShare = function (elementNode, config) {
    ...
    this.init = function () {
        ...
        if ( (isqqBrowser || isucBrowser )){
           ...
           // var html = '<div>'+
           //                  '<img src="'+ThinkPHP.PUBLIC+'/Mobile/images/icon/return.png"  onclick="javascript:history.back(-1);return false;" style="width: 90px;float: left;margin-left: 10px;">'+
           //                  '<img src="'+ThinkPHP.PUBLIC+'/Mobile/images/icon/share.png" onclick="showHint()" style="width: 90px;float: right;margin-right: 10px;">'+
           //              '</div>'
           //  $('#share').html(html);
           this.html();
        }
