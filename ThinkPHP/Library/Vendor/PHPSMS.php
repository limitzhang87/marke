...
class PHPSMS{
    ...
    //发送短信验证码
    private $sendCodeUrl = 'https://api.netease.im/sms/sendcode.action';

    //校验验证码
    private $verifyCodeUrl = 'https://api.netease.im/sms/verifycode.action';

    //发送通知类和运营类短信
    private $sendTemplateUrl = 'https://api.netease.im/sms/sendtemplate.action';
     ...
     * @return $result           [返回array数组对象]
     */
    public function sendCode($templateid,$mobile,$params='')
    {
