...
function export_csv($data = '',$dataWidth='', $filename = '',$sheet = false) {
    // Create new PHPExcel object
	import("Vendor.PHPExcel.Style");
	...
	foreach ( $dataWidth as $k=>$v ) {
		$objActSheet->getColumnDimension($Line[$k])->setWidth($v);
