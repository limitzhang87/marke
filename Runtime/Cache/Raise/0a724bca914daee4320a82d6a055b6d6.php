            ...
            <div class="lagar">
               ...
               <!--  <input type="hidden" name="download_id" value="<?php echo ($download_id); ?>"> -->
                ...
                <table id="house_table">
                    ...
                    <!-- <tr>
                        <td>
                            <h3><input type="radio" name="checked_houses" value="2" id="house_radio2">输入单位：</h3>
                        </td>
                    </tr>
                    <tr name="house_tr_2" style="display: none;">
                        <td>
                            <input type="text" name="building_num_2">栋
                        </td>
                    </tr>
                    <tr name="house_tr_2" style="display: none;">
                        <td>
                            <input type="text" name="unit_num_2">单元
                        </td>
                    </tr>
                    <tr name="house_tr_2" style="display: none;">
                        <td>
                            <input type="text" name="house_num_2">房
                        </td>
                    </tr> -->
                </table>
                <table>
...
//})();
    ...
    <script type="text/javascript">
    var houses_id = '<?php echo ($house); ?>'; //楼盘ID
