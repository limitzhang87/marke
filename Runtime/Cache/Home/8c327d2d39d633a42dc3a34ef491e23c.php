    ...
    <div class="div_houses">
        <div class="houses_head">
            <div id="houses_title" class="houses_title left" style="">
                ...
                <span class="font_title " style="padding-left: 5px; padding-top: 10px;">销控管理
                </span>
            </div>
        ...
        <div class="houses_tip">
            ...
            <center>
                <?php if(is_auth(AUTH_CHECK)): ?><span class="status_check1"></span>&nbsp;锁定审核
                    <span class="status_check2"></span>&nbsp;成交审核<?php endif; ?>
                <?php if(is_auth(AUTH_MARKETINCON)): ?><span class="status_none"></span>&nbsp;销控<?php endif; ?>
            </center>
        </div>
        <form method="POST">
        ...
        <center >
            <input type="hidden" name="u_id" id="submit_u_id" value="">
...
//})();
    ...
    <script type="text/javascript" src="/marke/Public/Mobile/js/getHouseMarketing.js"></script>
