...
<body>
    ...
    <div id="content">
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item" onclick="redirect( '<?php echo U('User/index',array('uid'=>$vo['id']));?> ')" >
                <div class="item_info">
                ...
                <div class="item_more">
                   <div style="font-size: 1.2rem;margin-top: 1.7rem;"><?php echo ($vo["g_name"]); ?></div>
                </div>
        ...
        <!-- 页面导航-->
            <a href="<?php echo U('User/'.ACTION_NAME ,array('kw'=>$kw));?>&page=2"></a>
...
//})();
    ...
    $(function(){
        if('<?php echo ($on); ?>' == 1){
            $('#s1').addClass('page_on');
            var url = '<?php echo U('User/forbit');?>';
            $('#s2').attr('onclick','redirect(\''+url+'\');');
        }else{
            $('#s2').addClass('page_on');
            var url = '<?php echo U('User/lists');?>';
    ...
    $('#search').click(function(){
        ...
        window.location.href = "/marke/index.php?s=/Home/User/lists/kw/" + kw;
    });

    $('#reflesh').click(function(){
        window.location.href = "/marke/index.php?s=/Home/User/lists";
    })

    $('#forbit').click(function(){
        window.location.href = "/marke/index.php?s=/Home/User/forbit";
    })
    var kw = '<?php echo ($kw); ?>';
