    ...
    <div id="content">
        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item_s" onclick="toRoom('<?php echo ($vo["id"]); ?>');">
            <div class="item_info" style="width: 100%;">
                ...
                <?php if($on == 'tocheck' ): if($vo['status'] == 1): ?><div class="item_status status_over">锁定待审核</div>
                    <?php else: ?>
                        <div class="item_status status_over">成交待审核</div><?php endif; endif; ?>
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <div id="navigation" align="center">
        <!-- 页面导航-->
            <a href="<?php echo U('Business/tocheck');?>&page=2"></a>
