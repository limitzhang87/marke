...
<body>
    ...
    <form action="" method="POST" style="width: 86%; margin: 0 auto;">
        <div class="form_model">
            <label>请输入标题:</label>
            <div><input type="text" name="title" placeholder="请输入公告标题"></div>
        </div>
        <div class="form_model">
            <label>请输入内容:</label>
            <div><textarea name="content" id="container"></textarea></div>
        </div>
        ...
        <div id="showPic" class="hide" style="height: 20rem;overflow-y: auto;"></div>
        <div id="showFile" class="hide" style="height: 8rem;overflow-y: auto;""></div>
        <center>
