                    ...
                    <tr name="house_tr_1">
                        <td name="house_td_1">
                            <select id="unit" name="unit" >
                                <?php if(is_array($_unit[$_building[0]['id']])): $i = 0; $__LIST__ = $_unit[$_building[0]['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$unit): $mod = ($i % 2 );++$i;?><option value="<?php echo ($unit["id"]); ?>"><?php echo ($unit["u_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>单元
                        </td>
                    </tr>
                    <tr name="house_tr_1">
                        <td name="house_td_1">
                            ...
                            <select id="room" name="room">
                                <?php if(is_array($_room[$firstUnit['id']] )): $i = 0; $__LIST__ = $_room[$firstUnit['id']] ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$room): $mod = ($i % 2 );++$i;?><option value="<?php echo ($room["id"]); ?>"><?php echo ($room["room_number"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>房
                        </td>
                    </tr>
                </table>
