    ...
    <div id="content">
        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item_s" onclick="toRoom('<?php echo ($vo["id"]); ?>');">
            <div class="item_info" style="width: 100%;">
                ...
                <?php if($vo['is_check'] == 1): ?><div class="item_status status_success">已审核</div>
                     <div style="position: absolute;bottom: 0.1rem;left: 2rem;">审核人:<?php echo ($vo["check_name"]); ?></div>
                <?php else: ?>
                    <div class="item_status status_over">未审核</div>
                    <div style="position: absolute;bottom: 0.1rem;left: 2rem;">待审核</div><?php endif; ?>
                <div style="position: absolute;bottom: 0.1rem;right: 1rem;"><?php echo (date("Y年m月d号 H:i:s",$vo["submit_time"])); ?></div>
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <div id="navigation" align="center">
        <!-- 页面导航-->
            <a href="<?php echo U('Business/lock');?>&page=2"></a>
