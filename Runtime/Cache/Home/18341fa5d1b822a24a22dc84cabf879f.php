...
<body>
    ...
    <div id="content" style="width: 94%;margin: 5px auto;">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="/marke<?php echo ($vo["path"]); ?>" onclick="show_pic_fun('<?php echo ($vo["id"]); ?>','/marke<?php echo ($vo["path"]); ?>')" data-url="<?php echo ($vo["path"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
         <div id="navigation" align="center">
        <!-- 页面导航-->
            <a href="<?php echo U('HousesImg/index');?>&page=2"></a>
     ...
     <?php if(is_auth(AUTH_HOUSESIMG_UPLOAD)): ?><div class="fixed_add" style="background-color: <?php echo ($bg_color); ?>; padding: 6px;" onclick="redirect('<?php echo U('HousesImg/edit');?>')">
