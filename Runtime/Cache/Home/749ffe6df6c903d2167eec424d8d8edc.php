...
<body>
    ...
    <div id="content">
        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item"  onclick="redirect('<?php echo U('Bulletin/info',array('id'=>$vo['id']));?>')">
            <div class="item_info">
        ...
        <!-- 页面导航-->
            <a href="<?php echo U('Bulletin/index');?>&page=2"></a>
    ...
    <?php if(is_auth(AUTH_BULL_MANAGE)): ?><div class="fixed_add" style="background-color: <?php echo ($bg_color); ?>; padding: 6px;" onclick="redirect('<?php echo U('Bulletin/add');?>')">
