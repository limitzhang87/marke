...
<body>
    ...
    <div>
        ...
        <div>
        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item_s" style="height: 3rem;">
                <div class="item_info" style="width: 100%;">
                    <span class="item_menu" style="background: none !important;"><?php echo ($vo["title"]); ?></span>
        ...
        <div style="display: -webkit-box;width:12rem;margin: 1rem auto;">
            <button class="button" style="background-color: red;width:12rem;margin: 0 1rem;color: #fff;" onclick="redirect('<?php echo U('bottom_add',array('id'=>$_id));?>')">添加底部公共栏</button>
        </div>
    </div>
