...
<body>
    ...
    <div class="module">
        <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item_s">
                <div class="item_info" onclick="redirect('<?php echo U('Group/menuList',array('id'=>$vo['id']));?>')">
                    <span class="item_title"><?php echo ($vo["name"]); ?></span>
                    <span class="group_num"><?php echo ($vo["usernum"]); ?>人</span>   
                </div>
                <div class="item_more">
                    <li class="arrow"></li>
                </div >
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="footer_btn" onclick="redirect('<?php echo U('add');?>')">
           添加会员组
        </div>
    </div>
