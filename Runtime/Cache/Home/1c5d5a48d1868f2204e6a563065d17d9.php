...
<body>
    ...
    <div class="item" onclick="redirect('<?php echo U('User/editInfo', array('field'=>'head_img'));?>')">
        <div class="item_info">
    ...
    <div class="item_s"  onclick="redirect('<?php echo U('User/editInfo', array('field'=>'phone'));?>')">
        <div class="item_info">
   ...
   <div class="item_s"  onclick="redirect('<?php echo U('User/editInfo', array('field'=>'nick_name'));?>')">
        <div class="item_info">
    ...
    <div class="item_s"  onclick="redirect('<?php echo U('User/editInfo', array('field'=>'sex'));?>')">
        <div class="item_info">
    ...
    <div class="item_s"  onclick="redirect('<?php echo U('User/editInfo', array('field'=>'password'));?>')">
        <div class="item_info">
            <div  class="titleN" style="">修改密码</div>
        </div>
        <div class="item_more">
            <li class="arrow"></li>
        </div>
