    ...
    <div action="" method="POST">
        ...
        <div class="sameroom_set">
            <div class="room_scroll">
                <?php if(is_array($_sameroom)): $i = 0; $__LIST__ = $_sameroom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="group" id="room_<?php echo ($vo["id"]); ?>" onclick="showPage('<?php echo ($vo["id"]); ?>')"><?php echo ($vo['r_name']); ?></div><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="room_page">
