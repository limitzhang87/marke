...
<body>
    ...
    <style type="text/css">
        ...
        .all>div:first-child{
            background: url(/marke/Public/Mobile/images/icon/all.png) no-repeat;
        }
        .new>div:first-child{
            background: url(/marke/Public/Mobile/images/icon/new.png) no-repeat;
        }
        .in>div:first-child{
            background: url(/marke/Public/Mobile/images/icon/in.png) no-repeat;
        }
        .over>div:first-child{
            background: url(/marke/Public/Mobile/images/icon/over.png) no-repeat;
        }
        .on{
            color: red;
        }
    ...
    <div>
        <div class="func">
            <?php if(is_array($button)): $i = 0; $__LIST__ = $button;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><div class="<?php echo ($value["class"]); ?>" data-id="<?php echo ($value["class"]); ?>">
                    <div></div>
    ...
    <?php if(is_auth(AUTH_BBORDER_ADD) || is_auth(AUTH_BBORDER_MANAGE)): ?><div class="fixed_add" style="background-color: <?php echo ($bg_color); ?>; padding: 6px;" onclick="redirect('<?php echo U('add');?>')">
...
//})();
    ...
    <script type="text/javascript">
        ...
        var button = '<?php echo ($buttonJson); ?>';
        ...
        $(function(){
            ...
            $('.func>div').click(function(){
                type = $(this).data('id');
                window.location.href = '/marke/index.php?s=/Home/BBorder/index/type/' + type;
