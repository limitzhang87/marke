...
<body>
    <div class="main">
        ...
        <div class="center">
            <input class="code" type="text" name="houses_title" id="houses_title" placeholder="楼盘名称">
     ...
     */
    function register() {
        var houses_title =  $('#houses_title').val();
        var phone = $('#phone').val();
        ...
        $.ajax({
            type: "POST",
            url: "/marke/index.php?s=/Home/Login/register_new",
            data: { 'type': 'register', 'houses_title':houses_title,'nick_name':nick_name, 'phone': phone, 'password': password },
            beforeSend: function() {
                $('.load_icon_3').show();
            },
            complete: function() {
