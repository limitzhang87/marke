...
<body>
        ...
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                ...
                <?php else: ?>
                   ...
                   <img style="width: 50px;height: 50px;" src="/marke<?php echo (get_cover($vo["icon"],'path')); ?>"><?php endif; ?>
            ...
            <td style="width: 200px;">
                ...
                <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('changeStatus', array('status'=>'0','ids'=>$vo['id']));?>" class="ajax-get">禁用</a>
                <?php else: ?>
                    <a href="<?php echo U('changeStatus', array('status'=>'1','ids'=>$vo['id']));?>" class="ajax-get">启用</a><?php endif; ?>
                <a href="<?php echo U('changeStatus?method=del&id='.$vo['uid']);?>">删除</a>
            </td>
    ...
    //导航高亮
    //highlight_subnav('<?php echo U('ButtomNav/index');?>');
    </script>
