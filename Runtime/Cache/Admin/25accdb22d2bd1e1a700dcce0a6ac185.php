...
<div class="tab-wrap">
    ...
    <form id="form" method="post" class="form-horizontal" onsubmit="getHousesTitle()" > 
        ...
        <div id="tab" class="tab-pane in" style="margin: 20px;">
            <label class="item-label">客户姓名：<?php echo ($info["nick_name"]); ?></label>
            <label class="item-label">客户手机：<?php echo ($info["phone"]); ?></label>
            <label class="item-label">楼盘标题：<?php echo ($info["houses_title"]); ?></label>
        ...
        <div class="form-item cf">
            ...
            <input type="hidden" name="houses_title" value="<?php echo ($info["houses_title"]); ?>">
...
<script type="text/javascript">
    ...
    function superCode() {
        $.ajax({
            url:'/marke/index.php?s=/Admin/Register/createCode',
            type:'POST',
            data:{'type':'create'},
            error:function(){
                alert('系列号生成失败，请刷新重试！');
