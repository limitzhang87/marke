...
<body>
    ...
    <tbody>
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["sld"]); ?></td>
            <td class=""><?php echo ($vo["houses_title"]); ?></td>
            <td class="">
                <?php if(($vo["is_check"]) == "1"): ?>是
                <?php else: ?>
                否<?php endif; ?>
            </td>
            <td class=""><?php echo ($vo["nick_name"]); ?></td>
            <td class=""><?php echo ($vo["phone"]); ?></td>
            <td class=""><?php echo (date("Y-m-d H:i:s",$vo["register_time"])); ?></td>
            <td style="width: 200px;">
                <a href="<?php echo U('bind',array('id'=>$vo['id']));?>">审核</a>
            </td>
